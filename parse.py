...
while keepRunning:
    ...
    time.sleep(30)#checks for open seats every 30 seconds
    if currentTime-initialTime > 21600: #messages the user that bot is still running after every 6 hours
        initialTime = round(time.clock())
        notify("It's been 6 hours, bot is still checking for seats")
